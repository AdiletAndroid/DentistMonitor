...
class FireDatabaseHelper {
    ...
    //  добавлениe нового доктора в базу данных
    ...
    // добавлениe нового календаря в базу данных
    ...
    // добавлениe новой записи пациента в календарь
    fun addAppointment(
        calendarId: String,
        ...
        val appointmentRef =
            rootRef.child("calendars").child(calendarId).child("appointments").child(appointmentId)
